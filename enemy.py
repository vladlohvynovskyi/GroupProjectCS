...
class Enemy:
    ...
    def _init_body_parts(self):
        ...
        # Calculate part HP based on total HP
        part_hp = max(1, self.max_hp // 4)  # Each part has ~1/4 of total HP
        
        self.body_parts = {
            BodyPart.HEAD: {"hp": part_hp, "max_hp": part_hp, "disabled": False},
            BodyPart.TORSO: {"hp": part_hp * 2, "max_hp": part_hp * 2, "disabled": False},
            BodyPart.LEFT_ARM: {"hp": part_hp, "max_hp": part_hp, "disabled": False},
            BodyPart.RIGHT_ARM: {"hp": part_hp, "max_hp": part_hp, "disabled": False},
            BodyPart.LEFT_LEG: {"hp": part_hp, "max_hp": part_hp, "disabled": False},
            BodyPart.RIGHT_LEG: {"hp": part_hp, "max_hp": part_hp, "disabled": False},
        }
